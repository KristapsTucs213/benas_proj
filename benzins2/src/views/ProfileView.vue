      ...
      <div v-else>
        ...
        <div v-if="editMode" class="card edit-card">
          ...
          <form @submit.prevent="updateInfo" class="d-flex flex-column gap-3">
            <input v-model="user.first_name" placeholder="First Name" class="form-control" />
            <input v-model="user.last_name" placeholder="Last Name" class="form-control" />
        ...
        <div class="card add-card">
          ...
          <form @submit.prevent="addSpending" class="d-flex flex-column gap-3">
            ...
            <input type="number" v-model="newSpending.total_spent" placeholder="Total Spent (€)" step="0.01" required class="form-control" />
            <input type="number" v-model="newSpending.liters" placeholder="Liters" step="0.1" required class="form-control" />
            <button type="submit" class="btn btn-primary btn-lg">Add Fuel</button>
          </form>
        </div>
